...
Suppose you have a spreadsheet that looks like this:

![](https://i.imgur.com/XrS4jAJ.png)

A simple way to import this dataset is from the Environment tab of RStudio, using the option Import Dataset > From Text (base) ... 

![](https://i.imgur.com/AOOpmHq.png)

The panel that pops-up will help you to (1) find the file you want to import; (2) preview the dataset; and (3) select values for the most common arguments. (Notice that Strings as factors is checked)

![](https://i.imgur.com/lVrTIHM.png)

Accepting all defaults is equivalent to running this code:
...
With the arguments you just learned about you can fix this problem from the root.
