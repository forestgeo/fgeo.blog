...
The document you are reading now is an rmarkdown document using the default working directory. Notice that it was a different notion of _woking directory_ compared to the project's working directory.
