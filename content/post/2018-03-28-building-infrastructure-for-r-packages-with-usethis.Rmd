...
# I use templates from fgeo.templates. I must have it installed but not loaded.
# install.packages("fgeo.templates")
```
...
# TODO: Move to .github/
# I use
# use_template(template = "SUPPORT.md", package = "fgeo.templates")
